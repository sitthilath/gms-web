...
<nav id="navbar" class="navbar fixed-top navbar-expand-lg">
  <div class="container-fluid">
    <a class="navbar-brand" href="./gms_home.php"><img class="nav-logo" alt="nav_logo"
  ...
  <div class="offcanvas-body">
    <div>
      <ul class="offcanvas-ul">
        <li>
          <a href="./index.php"><i class="fa fa-university" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Home</a>
        </li>
        <li>
          <a href="./gms_about.php"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;About</a>
        </li>
        <li>
          <a href="./gms_pro.php"><i class="fa fa-table" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Conference
            Program</a>
        </li>
        <li>
          <a href="./gms_call.php"><i class="fa fa-address-card" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Call For
            Abstracts</a>
        </li>
        <li>
          <a href="./gms_reg.php"><i class="fa fa-registered" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Registration</a>
        </li>
        <li>
          <a href="./gms_venue.php"><i class="fa fa-map" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Venue</a>
        </li>
      </ul>
    </div>
  </div>
